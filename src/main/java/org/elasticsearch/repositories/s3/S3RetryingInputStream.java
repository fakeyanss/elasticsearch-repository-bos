...
/**
 * Wrapper around an S3 object that will retry the {@link GetObjectRequest} if
 * the download fails part-way through, resuming from where the failure
 * occurred. This should be handled by the SDK but it isn't today. This should
 * be revisited in the future (e.g. before removing the {@link Version#V_7_0_0}
...
class S3RetryingInputStream extends InputStream {
    ...
    private InputStream openStream() throws IOException {
        try (AmazonS3Reference clientReference = blobStore.clientReference()) {
            ...
            final S3Object s3Object = SocketAccess
                    .doPrivileged(() -> clientReference.client().getObject(getObjectRequest));
